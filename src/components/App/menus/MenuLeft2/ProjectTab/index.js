...
export function ProjectTab() {
    ...
    return (
        <Box 
            ...
            bg="#282828"
        >
            <Box as={Flex} justifyContent='left' alignItems='center' pl="15px" w="100%" h="26px" bg="#202020">
            ...
            <Grid id='gridBack' w="100%" h="100%" pl="15px" pt="10px" templateColumns='repeat(12, 1fr)'>
